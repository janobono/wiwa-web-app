        ...
        <>
            ...
            <div className="flex flex-col p-5 gap-5 w-full">
                <div className="join join-vertical md:join-horizontal w-full">
                    <WiwaInput
                        className="join-item"
                        placeholder={managerResourceState?.resource?.codeLists.searchCodeList.placeholder}
                        value={searchField}
                    ...
                    <WiwaButton
                        ...
                        onClick={() => {
                            dialogState?.showDialog({
                                ...
                                title: managerResourceState?.resource?.codeLists.deleteCodeList.title,
                                message: managerResourceState?.resource?.codeLists.deleteCodeList.message,
            ...
            <div className="container p-5 mx-auto">
                <div className="flex flex-col items-center justify-center">
                    <div className="text-lg md:text-xl font-bold text-center">
                        {managerResourceState?.resource?.codeLists.codeListDialog.title}
                    </div>

                    <WiwaFormInputString
                        label={managerResourceState?.resource?.codeLists.codeListDialog.codeLabel}
                        required={true}
                        placeholder={managerResourceState?.resource?.codeLists.codeListDialog.codePlaceholder}
                        value={code}
                        setValue={setCode}
                        ...
                        validate={() => {
                            if (code.trim().length === 0) {
                                return {
                                    valid: false,
                                    message: managerResourceState?.resource?.codeLists.codeListDialog.codeRequired
                                };
                            }
                            return {valid: true};
                        }}
                    ...
                    <WiwaFormInputString
                        label={managerResourceState?.resource?.codeLists.codeListDialog.nameLabel}
                        required={true}
                        placeholder={managerResourceState?.resource?.codeLists.codeListDialog.namePlaceholder}
                        value={name}
                        setValue={setName}
                        ...
                        validate={() => {
                            if (name.trim().length === 0) {
                                return {
                                    valid: false,
                                    message: managerResourceState?.resource?.codeLists.codeListDialog.nameRequired
                                };
                            }
                            return {valid: true};
                        }}
