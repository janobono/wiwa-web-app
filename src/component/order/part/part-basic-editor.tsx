...
import BoardStructure from './board/board-structure.tsx';
        ...
        <>
            <div className="overflow-auto">
                <div className="grid grid-cols-4 min-w-max border">
                    ...
                    <div className="flex flex-row justify-start items-start p-5 border-4 border-black">
                        <div className="flex flex-col items-start justify-start">
                            <div className="w-7 h-7" title={commonResourceState?.resource?.partEditor.boardOrientation}>
                                {!partEditorState?.rotate && <BoardStructure rotate={false}/>}
                            </div>
            ...
            <BoardProvider>
                <BoardDialog
                    setData={(data) => partEditorState?.setBoard([BoardPosition.TOP], data)}
