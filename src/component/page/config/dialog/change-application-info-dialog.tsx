...
import { ApplicationInfo, LocaleData, uiClient } from '../../../../client';
    ...
    const handleSubmit = async () => {
        ...
        try {
            if (isFormValid) {
                ...
                if (wiwaError) {
                    setError(t(RESOURCE.COMPONENT.PAGE.CONFIG.DIALOG.CHANGE_APPLICATION_INFO.ERROR).toString());
                } else {
                        ...
                        >
                            <Dialog.Panel
                                ...
                                <div className="text-lg md:text-xl font-bold text-center mb-5">
                                    {t(RESOURCE.COMPONENT.PAGE.CONFIG.DIALOG.CHANGE_APPLICATION_INFO.TITLE)}
                                </div>
                                <form
                                    onSubmit={(event => {
