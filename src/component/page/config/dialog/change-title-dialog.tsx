...
const ChangeTitleDialog: React.FC<ChangeTitleDialogProps> = (props) => {
    ...
    const [titleData, setTitleData] = useState<configClient.TitleData>({items: []});
...
interface TitleEditorProps extends PropsWithChildren {
    language: string,
    titleData: configClient.TitleData,
    setTitleData: React.Dispatch<React.SetStateAction<configClient.TitleData>>
}
