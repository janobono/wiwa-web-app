        ...
        <>
            ...
            {showMarkdownDataDialog && (markdownData.items.length === languages.length) &&
                <ChangeMarkdownDialog
                    title={t(RESOURCE.COMPONENT.PAGE.CONFIG.DIALOG.CHANGE_WORKING_HOURS.TITLE)}
                    errorMessage={t(RESOURCE.COMPONENT.PAGE.CONFIG.DIALOG.CHANGE_WORKING_HOURS.ERROR)}
