...
import { WiwaLocaleComponentProps, WiwaTextArea } from './index';


const WiwaLocaleDataArea: React.FC<WiwaLocaleComponentProps> = (props) => {
...
export default WiwaLocaleDataArea;
